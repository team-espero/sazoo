...
const ZODIAC_REWARD_MODELS: ZodiacRewardModel[] = [
  ...
  { modelId: 'snake', zodiacKo: '¹ì', zodiacEn: 'Snake', zodiacJa: 'ÞÓ' },
  { modelId: 'horse', zodiacKo: '¸»', zodiacEn: 'Horse', zodiacJa: 'çí' },
  { modelId: 'sheep', zodiacKo: '¾ç', zodiacEn: 'Sheep', zodiacJa: 'Ú±' },
  { modelId: 'monkey', zodiacKo: '¿ø¼þÀÌ', zodiacEn: 'Monkey', zodiacJa: 'ãé' },
...
const getWelcomeGiftCopy = (
  ...
  if (language === 'ja') {
    return {
      title: '«¦«§«ë«««à«®«Õ«Èª¬?ª­ªÞª·ª¿¡£',
      body: `${profileName || 'ª¢ªÊª¿'}ªË${zodiacName}ªÎ3D«¢«»«Ã«È¡¸${modelName}¡¹ªòñüªêªÞª·ª¿¡£`,
    };
  }
