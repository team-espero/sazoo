...
const serverEnvSchema = z.object({
  ...
  DASHBOARD_ACCESS_KEY: z.string().default(''),
...
export function parseServerEnv(source) {
  ...
  return {
    ...
    dashboardAccessKey: parsed.data.DASHBOARD_ACCESS_KEY.trim(),
    dashboardAllowedEmails: normalizeUris(parsed.data.DASHBOARD_ALLOWED_EMAILS).map((value) => value.toLowerCase()),
